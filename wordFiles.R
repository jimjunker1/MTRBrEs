...
###########
# to word
system('pandoc -o text/MS.docx text/MS.md -s -S --bibliography references.bib --csl ecology.csl')
...
# to word
system('pandoc -o text/answers_to_reviewers.docx text/answers_to_reviewers.md -s -S --bibliography references.bib --csl ecology.csl')
